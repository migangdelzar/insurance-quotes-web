...
intentionally not committed. Use the stable full-stack workflow link above to
generate the current artifact; individual run links are historical evidence.
