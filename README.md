...
generated by Playwright and uploaded by the manual `record_demo=true` mode of
the [full-stack workflow](.github/workflows/full-stack-e2e.yml); binaries are
intentionally not committed. The latest verified artifact is available from
[run 30384361064](https://github.com/migangdelzar/insurance-quotes-web/actions/runs/30384361064).
...
- Full-stack demo recording mode is manually dispatched with
  `record_demo=true` and uploads named Playwright video artifacts.
